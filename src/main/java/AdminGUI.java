...
public class AdminGUI {
    ...
    public void createCompositeTable(List<BaseProduct> menuItems) {
        ...
        for (int i = 0; i < menuItems.size(); i++) {
            ...
            matrix[i][0] = (menuItems.get(i)).getTitle();
            matrix[i][1] = String.valueOf((menuItems.get(i)).getRating());
            matrix[i][2] = String.valueOf((menuItems.get(i)).getCalories());
            matrix[i][3] = String.valueOf((menuItems.get(i)).getProtein());
            matrix[i][4] = String.valueOf((menuItems.get(i)).getFat());
            matrix[i][5] = String.valueOf((menuItems.get(i)).getSodium());
            matrix[i][6] = String.valueOf((menuItems.get(i)).getPrice());
